...
<p>Jeff has a modular structure which make it easily extensible.</p>",
  ...
  /* NEWS */
	...
	"archive"=>"archive",
  /* BORROMEO */
	"manageDocCtg"=>"management of the document categories",
	"manageDoc"=>"documents management",
	"BorromeoAdminTitle"=>"Borromeo - Administration",
	"name"=>"name",
	"creation_date"=>"creation",
	"last_edit_date"=>"last edit",
	"ctgs"=>"categories",
	"tutor_groups"=>"tutor groups",
	"tutor_users"=>"tutor users",
	"author_groups"=>"author groups",
	...
	"text"=>"text",
	"image"=>"image",
	"mergeAlert"=>"Sure about merging the revision? The operation can not be reversed",
	"comment"=>"comment",
	"mergeRevision"=>"merge revision",
	"revisionHistory"=>"revision history",
	"noRevisions"=>"no revisions",
	"newRevision"=>"new revision",
	"createNewRevisionFrom"=>"create new revision from",
	"create"=>"create",
	"attachment"=>"attachment",
	"attachments"=>"attachments",
	"addAttachment"=>"add attachment",
	"annotation"=>"annotation",
	"loadOneOrMoreFiles"=>"<p>Load one or more files</p>",
	"annotations"=>"annotations",
	"addNote"=>"add note",
	"editNote"=>"edit note",
	"toggleIndex"=>"toggle index",
	"docAnnotations"=>"notes",
	"toggleAnnotations"=>"toggle notes",
	"LoadedFiles"=>"Loaded files",
	"content"=>"content",
	"publicRevision"=>"public revision",
	"workRevision"=>"work revision",
	"ConfirmDeleteSubchapter"=>"Continue with the deletion of the subchapter? The operation can't be reverted, and all contents, revisions, annotations will be deleted too.",
	"ConfirmDeleteChapter"=>"Continue with the deletion of the subchapter? The operation can't be reverted, and all subchapters, contents, revisions, annotations will be deleted too.",
	"createNewPad"=>"create a new realtime pad",
	"realtimePad"=>"realtime Pad",
	"cantCreateEtherpadGroup"=>"Etherpad, group creation failed",
	"cantCreateEtherpadAuthor"=>"Etherpad, author creation failed",
	"cantCreateEtherpadPad"=>"Etherpad, pad creation failed",
